  ...
  return (
    <div className="flex min-h-screen bg-[#f5f4f0] font-['Inter',sans-serif] selection:bg-[#ef4d23]/20 selection:text-[#ef4d23] p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto my-auto bg-white/95 backdrop-blur-md rounded-3xl border border-neutral-200/80 shadow-xl overflow-hidden flex flex-col lg:flex-row min-h-[640px] relative z-10">
        {/* Left: Showcase panel with ambient halo */}
        <div className="lg:w-1/2 bg-[#0b0f1a] text-white p-8 sm:p-12 flex flex-col justify-between relative overflow-hidden border-r border-white/10">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="space-y-3 pt-6">
              ...
              <p className="text-[14px] text-neutral-400 leading-relaxed max-w-sm">
                Create your workspace in under 3 minutes. Unlock automated return calendars, notice OCR defense, and verified health score ratings.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-8 relative z-10">
            {[
              locale === 'hi' ? 'सूक्ष्म व्यवसायों के लिए निःशुल्क स्टार्टर योजना' : 'Free starter plan for micro enterprises',
              locale === 'hi' ? '25% राज्य पूंजीगत सब्सिडी का स्वतः मिलान' : 'Auto-matched 25% state capital subsidies',
              locale === 'hi' ? 'सत्यापित B2B सप्लायर एवं क्रिएटर अनुबंध' : 'Verified B2B supplier & creator contracts',
            ].map((f, i) => (
        ...
        <div className="lg:w-1/2 p-8 sm:p-12 flex flex-col justify-between">
          ...
          <div className="w-full max-w-sm mx-auto space-y-5 my-auto">
            <div className="space-y-1">
              ...
              <p className="text-[13px] text-neutral-500">{t('signUpSubtitle')}</p>
            </div>
            ...
            <div className="pt-3 border-t border-neutral-100 text-center text-[13px] text-neutral-500">
              ...
              <Link href="/login" className="font-semibold text-[#ef4d23] hover:underline">
                {t('signInLink')}
              </Link>
            </div>
          </div>
